...
ibm_apim is a minimal, re-colorable, multi-column theme which uses HTML5
and includes many advanced theme settings to allow you to customize 
the theme to your requirements.
It has been styled to match IBM API Management but can be easily customised to suit your own needs.


-- REQUIREMENTS --

ibm_apim 7.x-2.x is a sub-theme of Adaptivetheme, you must download and install
...
* Theme settings and layout: ibm_apim includes lots of theme settings including
  the ability to change the layout and support for mobile devices. Visit the
  theme settings page admin/appearance/settings/ibm_apim to configure your settings.
...
* Color options: Enable the theme at admin/appearance, and visit
  admin/appearance/settings/ibm_apim to modify the color scheme if desired.

* Menus: The ibm_apim theme does not support the hard coded menu defaults. To setup
...
ibm_apim supports the Superfish module which is a dynamic menu module and enables 
