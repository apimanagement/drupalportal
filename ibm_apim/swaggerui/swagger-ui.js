...
function program10(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n</div>\n<div class='container' id='resources_container'>\n  <ul id='resources'></ul>\n\n  <div class=\"footer\">\n    <br>\n    <br>\n    <h4 class=\"summaryText\">[ <span style=\"font-variant: small-caps\">base url</span>: ";
    ...
    OperationView.prototype.showStatus = function(response) {
      ...
      if (!content) {
    	if (response.status == 0) {
    	  code = jQuery('<code />').text("no content. A security error has occurred. If using a self-signed certificate on your gateway, you will need to accept it in your browser, which you can do by accessing the Request URL above in a different tab.");
    	} else {
